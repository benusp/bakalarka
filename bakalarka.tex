...
\begin{document}
	...
	\begin{itemize}
		...
		\item univerzálnosť podporavaných testo (použiteľnosť testov v inom pracovnom rámci)
		\item využitie mockov pri testovaní
		\item správa spúšťania testov (možnosť rozdelenia testov do skupín, automatické spúšťanie a pod.)
		\item zobrazenie výsledkov testovania (prehľadnosť, ako rýchlo sa dá zistiť, ktorý test skončil s chyba a aká bola chyba a pod.)
